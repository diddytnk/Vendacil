...
$sql = $pdo->prepare("UPDATE `usuarios` SET nome=?, endereco=?, numero=?, cidade=?, estado=?, rg=?, cpf=?, sexo=?, `data`=?, email=?, senha=?, sobrenome=?  WHERE id=?");
$sql->execute(array(
    $_POST['nome'], $_POST['end'], $_POST['num'], $_POST['cidade'], $_POST['estado'],
    $_POST['rg'], $_POST['cpf'], $_POST['sexo'], $_POST['datanasc'], $_POST['email'],
    $_POST['senha'], $_POST['sobrenome'], $_POST['id']));
