...
<body>
    <nav class="navbar bg-warning">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php"><img src="..\Recursos/CAIXA.png" alt="" width="50px"></a>
...
<div class="row py-2">
            <div class="col-md-6">
            <input class="form-control" type="text" name="cep" id= "" placeholder="CEP" required>
            </div>
            </div>
