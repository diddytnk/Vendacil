    ...
    <div class="container mt-4 text-center">
        ...
        <form action="../Web/bd2.php" method="post">
            ...
            <div class="row py-2">
                ...
                <div class="col-md-6">
                    <p class="mt-3"><strong> Data de expiração </p>
        ...
        <div class="row py-2">
            ...
            <div class="row py-2 border border-dark rounded mt-3">
                <div class="col-md-15">
                    <label class="form-label" for="senha">Código de segurança</label>
                    <input class="form-control" type="password" name="codigo" id="senha" required>
                </div>
